...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { publishable_key: @seller.publishable_key, secret_key: @seller.secret_key, stripe_user_id: @seller.stripe_user_id, user_id: @seller.user_id } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { publishable_key: @seller.publishable_key, secret_key: @seller.secret_key, stripe_user_id: @seller.stripe_user_id, user_id: @seller.user_id } }
