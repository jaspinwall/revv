...
class ChargesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create charge" do
    assert_difference('Charge.count') do
      post charges_url, params: { charge: { application_fee: @charge.application_fee, purchase_id: @charge.purchase_id, source: @charge.source } }
    end
  ...
  test "should update charge" do
    patch charge_url(@charge), params: { charge: { application_fee: @charge.application_fee, purchase_id: @charge.purchase_id, source: @charge.source } }
