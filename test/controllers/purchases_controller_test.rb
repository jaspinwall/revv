...
class PurchasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase" do
    assert_difference('Purchase.count') do
      post purchases_url, params: { purchase: { buyer_id: @purchase.buyer_id, product_id: @purchase.product_id } }
    end
  ...
  test "should update purchase" do
    patch purchase_url(@purchase), params: { purchase: { buyer_id: @purchase.buyer_id, product_id: @purchase.product_id } }
